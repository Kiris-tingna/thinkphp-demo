		...
		<div class="col-xs-10">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" class="form-horizontal" action="<?php echo U(GROUP_NAME.'/Auth/addUserHandle');?>" method="post">
						...
						<div class="form-group">
							<div class="col-sm-1"></div>
							<div class="input-group col-sm-7">
								<div class="input-group-addon">用户组别</div>
								<?php if(is_array($group)): foreach($group as $key=>$g): ?><label class="checkbox-inline">	
										 <input type="checkbox" name="group[]" value="<?php echo ($g["id"]); ?>"> <?php echo ($g["title"]); ?>
